...
public class Cargar {
    ...
    public static void main(String[] args) {
      ...
      info_disponible_de = teclado.nextInt();
        ...
        datos.Proceso_inscripcion inscripcion_est3 = new datos.Proceso_inscripcion(false, a_pendientes3, "Asignaturas en curso", "tercer fraccionamiento pendiente");
        ...
        datos.Informacion_academica info_academica1 = new datos.Informacion_academica(16, "Sobresalientes", "lunes a jueves de 7:00 am a 11:00 am", planes1, tutores1);
        ...
        datos.Informacion_academica info_academica2 = new datos.Informacion_academica(16, "Excelente", "lunes a MIercoles de 7:00 am a 11:00 am y viernes de 7:00 am a 9:00 am", planes2, tutores2);

        String[] planes3 = {"Estudiante que no debe nivelar", "suspendió semestre en 2021 - I"};
        String[] tutores3 = {"No infromados"};
        datos.Informacion_academica info_academica3 = new datos.Informacion_academica(16, "Sobresalientes", "lunes a jueves de 7:00 am a 11:00 am", planes3, tutores3);


        //**CLASE Curso**

        datos.Curso curso1 = new datos.Curso(10002, "Física innecesaria para ingenieros", 4 , false);
        datos.Curso curso2 = new datos.Curso(10007, "Álgebra lineal", 6 , false);
        datos.Curso curso3 = new datos.Curso(10043, "Programación Orienteada a Objetos", 4, true);
        ...
        datos.Estudiante estudiante1 = new Estudiante("Andrés David Ramírez Chiquillo",100243124, "Masculino, creo", "andruvrch@gmail.com", "aramirez@unal.edu.co" , info_academica1, curso1, datos1, inscripcion_est1);
        datos.Estudiante estudiante2 = new datos.Estudiante("Laura Daniela Agudelo Cruz",110243124, "Femenino", "lauraagudelo@unal.edu.co" , info_academica2, curso2, datos2, inscripcion_est2);
